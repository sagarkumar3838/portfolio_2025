...
function HeaderTitle() {
  ...
  return (
    ...
    <div className="min-h-screen w-full overflow-hidden bg-black">
      <div className="relative h-72 w-screen overflow-hidden [mask-image:radial-gradient(50% 50%, white, transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#369eff,transparent_90%)] before:opacity-100 after:absolute after:border-2 after:-left-1/2 after:top-1/2 after:aspect-[1/1.8] after:w-[200%] after:rounded-[50%] after:border-b after:border-[#7876c566] after:bg-zinc-900">
      ...
      <div className="mx-auto -mt-60 w-screen max-w-2xl relative z-10">
        <div className="bg-transparent backdrop-blur-lg border border-gray-800 p- w-48 h-48  mx-auto grid place-content-center rounded-full">
        <img src='/images/profile_img.png' className='rounded-full'/>
        </div>
      </div>
      <article className="text-white pt-2  mx-auto block text-center z-10 relative">
        <h1 className="text-center text-5xl font-medium py-3">
          -Hello
        </h1>
        <h2>I'm <span className='text-5xl text-sky-500'>Sagar Samal,</span></h2>
        <h1 className=' '> <span> <FlipWords words={words}  /></span></h1>
      </article>
     <div className='flex items-center justify-center  '>
     <div className=' text-center gap-2 flex items-center justify-center mt-4 border rounded-full h-14 w-72 bg-white '>
     ...
     <div className=' mt-8 h-[80px] grid place-content-center bg-[#00FF00] text-black text-xl font-medium'>
        <ScrollBaseAnimation
          // delay={500}
          baseVelocity={3}
