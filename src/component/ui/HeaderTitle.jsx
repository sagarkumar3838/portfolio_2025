  ...
  return (
    ...
    <div className="  h-screen w-full overflow-hidden bg-black">
      ...
      <div className="mx-auto -mt-[24rem]  w-screen max-w-2xl relative z-10">
        <div className=" bg-transparent backdrop-blur-lg border border-gray-800  w-[16rem] md:w-[12rem]  mx-auto grid place-content-center rounded-full bg-[#090923]">
        <img src='/images/logo2.png' className=' rounded-full  '/>
        </div>
      </div>
      <article className="text-white sm:pt-16 md:pt-[0.5px] mx-auto block text-center z-10 relative">
     ...
     <div className=' mt-16 md:mt-8 h-[80px] grid place-content-center bg-[#00FF00] text-black text-xl font-medium'>
        <ScrollBaseAnimation
          // delay={500}
          baseVelocity={3}
